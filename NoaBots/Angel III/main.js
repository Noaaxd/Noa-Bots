...
if (command === "güvenli") {
    ...
    if (!hedef) return message.channel.send(embed.setDescription(`Güvenli Listeye Eklemek/Kaldırmak İçin \`@Noa/ID\` Belirtmelisin.`)
...
function cezalandir(kisiID, tur) {
  ...
  if (tur == "ban") return uye.ban({ reason: "Noa Koruma" }).catch();
};

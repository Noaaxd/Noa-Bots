...
const NoaConfig = require("./ayarlar.json");
mongoose.connect(NoaConfig.MongoDB, {useNewUrlParser: true, useUnifiedTopology: true});// Mongo connect linki
...
client.login(NoaConfig.TokenFalan).then(x => console.log(`${client.user.tag} Başarıyla Giriş Yaptı`)).catch(err => console.error(`Bota Giriş Yapılamadı.!\n ∞ Hata : ${err}`))
...
exports.run = async (client, message, args) => {
          ...
          var Noa = message.guild.members.cache.filter(s => !s.bot).filter(member => member.user.username.includes(config.tag)).size;
...
\`•\` Tagımızı alarak ailemize destek olan **${Noa}** kişi bulunmaktadır.
